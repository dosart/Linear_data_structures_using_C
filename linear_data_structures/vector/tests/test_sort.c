...
void test_sort() {
    struct sort_test_item  bubble_sort_item =
            {
                    .sort = vector_bubble_sort,
                    .cmp = cmp_sort,
                    .message = "Bubble sort"
            };

    struct sort_test_item  insertion_sort_item =
            {
                    .sort = vector_insertion_sort,
                    .cmp = cmp_sort,
                    .message = "Insertion sort"
            };

    struct sort_test_item  sort_test_items[] = {bubble_sort_item, insertion_sort_item};
