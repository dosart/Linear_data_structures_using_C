...
void test_delete1(void *key) { *(int *)key = 0; }
...
void test_search() {
  ...
  struct search_test_item binary_search_item = {.search = vector_binary_search,
                                                .cmp = cmp_binary_search,
                                                .message = "Binary_search"};

  struct search_test_item linear_search_item = {.search = vector_find,
                                                .cmp = cmp_linear_search,
                                                .message = "Linear_search"};

  struct search_test_item search_test_items[] = {binary_search_item,
                                                 linear_search_item};
